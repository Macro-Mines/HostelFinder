  ...
  if (hostelId) {
    try {
      hostelDetailContent.innerHTML =
        '<img src="images/loading.gif" alt="loading" width="100px"><p class="loading-message">Loading hostel details...</p>';
      ...
      if (docSnap.exists) {
        ...
        hostelDetailContent.innerHTML = `
                    <div class="hostel-detail-card">
                        <img src="${foundHostel.image}" alt="${
          foundHostel.name
        }" class="detail-image">
                        <div class="detail-content">
                            <h1>${foundHostel.name}</h1>
                            <p class="detail-location"><img src="images/location-pin.gif" style="width: 40px; height: 40px; vertical-align: middle; margin-right: 0px;"> ${
                              foundHostel.location
                            }</p>
                            
                            <p class="detail-description">${
                              foundHostel.description
                            }</p>
                            ...
                            <div class="detail-grid">
                                ...
                                <img src="images/rent.gif" style="width: 40px; height: 40px; vertical-align: bottom; padding-bottom: 0px; margin-bottom: 0px";>
                                    ...
                                    <span>₹${
                                      foundHostel.roomRent
                                        ? foundHostel.roomRent.min
                                        : "N/A"
                                    } - ₹${
          foundHostel.roomRent ? foundHostel.roomRent.max : "N/A"
        } per month</span>
                                </div>
                                ...
                                <img src="images/group.gif" style="width: 40px; height: 40px; vertical-align: bottom; padding-bottom: 0px; margin-bottom: 0px";>
                                    ...
                                    <span>${
                                      foundHostel.roomCapacity &&
                                      Array.isArray(foundHostel.roomCapacity) &&
                                      foundHostel.roomCapacity.length > 0
                                        ? foundHostel.roomCapacity.join(", ")
                                        : "N/A"
                                    }</span>
                                </div>
                            ...
                            <div class="detail-section">
                                ...
                                <ul class="facilities-list">
                                    ${
                                      foundHostel.facilities &&
                                      Array.isArray(foundHostel.facilities) &&
                                      foundHostel.facilities.length > 0
                                        ? foundHostel.facilities
                                            .map(
                                              (facility) =>
                                                `<li>${facility}</li>`
                            ...
                            <div class="detail-section">
                                ...
                                <p><strong>Owner Name:</strong> ${
                                  foundHostel.ownerContactName || "N/A"
                                }</p>
                                <p><strong>Phone:</strong> <a href="tel:${
                                  foundHostel.ownerPhone
                                }">${foundHostel.ownerPhone || "N/A"}</a></p>
                                <p><strong>Email:</strong> <a href="mailto:${
                                  foundHostel.ownerEmail
                                }">${foundHostel.ownerEmail || "N/A"}</a></p>
                            </div>
