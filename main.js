...
const hostels = [
  ...
  { name: "VBU Hostel 1", lat: 24.026, lng: 85.377, address: "Near VBU Main Gate, Merawal, Hazaribagh" },
  { name: "VBU Hostel 2", lat: 24.027, lng: 85.379, address: "Sindur Road, Merawal, Hazaribagh" },
  { name: "VBU Hostel 3", lat: 24.025, lng: 85.375, address: "Merawal Bypass, Hazaribagh" },
  { name: "VBU Hostel 4", lat: 24.028, lng: 85.378, address: "Sindur Village, Hazaribagh" },
  { name: "VBU Hostel 5", lat: 24.024, lng: 85.376, address: "Near Merawal Market, Hazaribagh" },
  { name: "VBU Hostel 6", lat: 24.026, lng: 85.380, address: "Sindur Main Road, Hazaribagh" },
  { name: "VBU Hostel 7", lat: 24.029, lng: 85.374, address: "Merawal Colony, Hazaribagh" },

  // University of Delhi (Delhi)
  { name: "DU Hostel 1", lat: 28.686, lng: 77.211, address: "North Campus, Delhi" },
  { name: "DU Hostel 2", lat: 28.688, lng: 77.215, address: "Kamla Nagar, Delhi" },
  { name: "DU Hostel 3", lat: 28.684, lng: 77.213, address: "GTB Nagar, Delhi" },
  { name: "DU Hostel 4", lat: 28.687, lng: 77.217, address: "Vishwavidyalaya, Delhi" },
  { name: "DU Hostel 5", lat: 28.689, lng: 77.210, address: "Model Town, Delhi" },
  { name: "DU Hostel 6", lat: 28.685, lng: 77.212, address: "Hudson Lane, Delhi" },
  { name: "DU Hostel 7", lat: 28.690, lng: 77.214, address: "Malka Ganj, Delhi" },

  // University of Mumbai (Mumbai)
  { name: "MU Hostel 1", lat: 19.073, lng: 72.899, address: "Kalina, Mumbai" },
  { name: "MU Hostel 2", lat: 19.075, lng: 72.902, address: "Santacruz East, Mumbai" },
  { name: "MU Hostel 3", lat: 19.072, lng: 72.900, address: "Kurla, Mumbai" },
  { name: "MU Hostel 4", lat: 19.074, lng: 72.898, address: "Vidyavihar, Mumbai" },
  { name: "MU Hostel 5", lat: 19.076, lng: 72.901, address: "Sion, Mumbai" },
  { name: "MU Hostel 6", lat: 19.071, lng: 72.903, address: "Chembur, Mumbai" },
  { name: "MU Hostel 7", lat: 19.077, lng: 72.897, address: "Ghatkopar, Mumbai" },

  // Anna University (Chennai) - Randomized
  { name: "AU Hostel 1", lat: 13.013, lng: 80.238, address: "Guindy, Chennai" },
  { name: "AU Hostel 2", lat: 13.016, lng: 80.244, address: "Saidapet, Chennai" },
  { name: "AU Hostel 3", lat: 13.011, lng: 80.241, address: "Adyar, Chennai" },
  { name: "AU Hostel 4", lat: 13.014, lng: 80.239, address: "Velachery, Chennai" },
  { name: "AU Hostel 5", lat: 13.012, lng: 80.243, address: "Taramani, Chennai" },
  { name: "AU Hostel 6", lat: 13.015, lng: 80.237, address: "Kotturpuram, Chennai" },
  { name: "AU Hostel 7", lat: 13.017, lng: 80.242, address: "Besant Nagar, Chennai" },

  // University of Calcutta (Kolkata) - Randomized
  { name: "CU Hostel 1", lat: 22.573, lng: 88.362, address: "College Street, Kolkata" },
  { name: "CU Hostel 2", lat: 22.575, lng: 88.367, address: "Bowbazar, Kolkata" },
  { name: "CU Hostel 3", lat: 22.570, lng: 88.364, address: "Sealdah, Kolkata" },
  { name: "CU Hostel 4", lat: 22.576, lng: 88.361, address: "Park Circus, Kolkata" },
  { name: "CU Hostel 5", lat: 22.572, lng: 88.366, address: "Ballygunge, Kolkata" },
  { name: "CU Hostel 6", lat: 22.574, lng: 88.363, address: "Salt Lake, Kolkata" },
...
const universityLocations = {
  ...
  "university-c": { lat: 13.012, lng: 80.240, zoom: 14 }, // Anna University
...
function showMap(centerLat, centerLng, zoomLevel) {
  ...
  if (mapInstance) {
    mapInstance.setView([centerLat, centerLng], zoomLevel || mapInstance.getZoom());
    return;
  }
  ...
  navigator.geolocation.getCurrentPosition(
    function (position) {
      ...
      mapInstance = L.map("hostel-map").setView([userLat, userLng], zoomLevel || 15);
