document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculateExpenses() {
        ...
        const monthlyTotal = monthlyRent + foodBudget + electricity + internet +
                             transport + personalCare + academicSupplies + entertainment + miscFund;
    ...
    const allInputs = [
        initialSetupInput, roomEssentialsInput, monthlyRentInput, foodBudgetInput,
        electricityInput, internetInput, transportInput, personalCareInput,
        academicSuppliesInput, entertainmentInput, miscFundInput
    ];
    ...
    document.addEventListener('click', (event) => {
        ...
        if (!calculatorPanel.contains(event.target) && !calculatorFab.contains(event.target) && calculatorPanel.classList.contains('active')) {
